...
/**
 * It is used to set settings of the 'NumberOfProducts' calculation variable.
 */
class NumberOfProductsVariableSettings implements VariableSettings
{
    /**
     ...
     *
     * @param  array $array
     * @return NumberOfProductsVariableSettings
     */
