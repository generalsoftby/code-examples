...
class NotificationMessageBuilderJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        if (0 == $notificationRecipients->count()) {
            return;
        }
    ...
    protected function getNotificationMessage($recipient): NotificationMessage
    {
        ...
        $subject = NotificationChannelTypesEnum::EMAIL == $this->notification->channel_type ?
        ...
        $attachments = NotificationChannelTypesEnum::EMAIL == $this->notification->channel_type ?
    ...
    {
        if (NotificationEventsEnum::MESSAGE_VIA_EMAIL_FROM_HELPDESK === $notification->event) {
