...
class StatisticsBlockMarketplacesDashboard extends Component {
...
export default connect(
    state => ({
        statTotalData: state.staticstics.mainStatistics.markeplaces,
    })
)(StatisticsBlockMarketplacesDashboard);
