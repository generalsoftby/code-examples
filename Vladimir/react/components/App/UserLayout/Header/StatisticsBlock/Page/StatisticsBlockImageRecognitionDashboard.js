...
class StatisticsBlockImageRecognitionDashboard extends Component {
...
export default connect(
    state => ({
        statTotalData: state.staticstics.mainStatistics.image_recognition,
    })
)(StatisticsBlockImageRecognitionDashboard);
