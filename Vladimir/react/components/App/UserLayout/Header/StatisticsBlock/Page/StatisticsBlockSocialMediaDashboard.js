...
class StatisticsBlockSocialMediaDashboard extends Component {
...
export default connect(
    state => ({
        statTotalData: state.staticstics.mainStatistics.social_media,
    })
)(StatisticsBlockSocialMediaDashboard);
