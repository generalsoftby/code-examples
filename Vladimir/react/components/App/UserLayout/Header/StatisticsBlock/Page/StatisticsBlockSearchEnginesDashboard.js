...
class StatisticsBlockSearchEnginesDashboard extends Component {
...
export default connect(
    state => ({
        statTotalData: state.staticstics.mainStatistics.search_engines,
    })
)(StatisticsBlockSearchEnginesDashboard);
